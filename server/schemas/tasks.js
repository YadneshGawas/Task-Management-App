    ...
    if (this.isModified()) {
      ...
      if (original) {
        ...
        if (this.isModified("stage")) {
          this.activities.push({
            //Issue found not fixed yet
            //Issue is "stage" is getting triggered without the stage being updated
            //Issue is occuring due to putStatus API as it frequently updates the stage
            //Solution is to only run the API when progress is 100 instead of running frequently
            type: "stage",
